...
The value is in the *consequences* section. Six months from now the question will not be "what did we decide" — it will be "why can't I just add a quantity column."
